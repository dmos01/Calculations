...
namespace Mehroz
{
    ...
    public struct Fraction : IComparable, IFormattable
    {
        ...
        public int ToInt32()
        {
            if (m_Denominator == 0)
            {
                throw new FractionException(
                    string.Format("Cannot convert {0} to Int32", IndeterminateTypeName(m_Numerator)),
        ...
        public long ToInt64()
        {
            ...
            {
                throw new FractionException(
                    string.Format("Cannot convert {0} to Int64", IndeterminateTypeName(m_Numerator)),
                    new NotFiniteNumberException());
            }
        ...
        public Fraction Inverse()
        {
            ...
            frac.m_Numerator = m_Denominator;
            frac.m_Denominator = m_Numerator;
            return frac;
        }
        ...
        string IFormattable.ToString(string format, IFormatProvider formatProvider) =>
            m_Numerator.ToString(format, formatProvider) + "/" + m_Denominator.ToString(format, formatProvider);
        ...
        private static Fraction Negate(Fraction frac) =>
            ...
            new Fraction(-frac.m_Numerator, frac.m_Denominator);
