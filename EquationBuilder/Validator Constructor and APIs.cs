...
namespace EquationBuilder
{
    ...
    public partial class Validator
    {
        ...
        /// <summary>
        ///     Validates the order of elements, expands Constants, adds implied multiplication operators and replaces E where possible. Returns true if the order of elements is valid.
        /// </summary>
